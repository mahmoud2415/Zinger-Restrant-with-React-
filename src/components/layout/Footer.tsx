      ...
      <div className="max-w-7xl mx-auto space-y-10">
        ...
        <div className="flex flex-col items-center space-y-3">
          ...
          <p className="text-xs text-zinc-400 font-cairo max-w-lg mx-auto leading-relaxed">
            نقدم لكم أشهى وأجود ساندوتشات البرجر الفاخر، الكريب، البيتزا الأمريكي، الباستا، وتش رول، والوجبات الغرقانة جبنة مع أسرع خدمة توصيل بفروعنا في فاقوس، أبو كبير، والإسماعيلية.
          </p>
        </div>
